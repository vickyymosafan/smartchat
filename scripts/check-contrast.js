...
const combinations = [
  ...
  { fg: 'gray950', bg: 'white', usage: 'Primary text on white background', size: 'normal' },
  { fg: 'gray950', bg: 'gray50', usage: 'Primary text on off-white', size: 'normal' },
  { fg: 'gray950', bg: 'gray100', usage: 'Primary text on light surface (assistant message)', size: 'normal' },
  
  // Secondary text
  { fg: 'gray700', bg: 'white', usage: 'Secondary text on white', size: 'normal' },
  { fg: 'gray700', bg: 'gray50', usage: 'Secondary text on off-white', size: 'normal' },
  { fg: 'gray700', bg: 'gray100', usage: 'Secondary text on light surface', size: 'normal' },
  
  // Muted text
  { fg: 'gray600', bg: 'white', usage: 'Muted text on white', size: 'normal' },
  { fg: 'gray600', bg: 'gray50', usage: 'Muted text on off-white (status, labels)', size: 'normal' },
  { fg: 'gray600', bg: 'gray100', usage: 'Muted text on light surface', size: 'normal' },
  
  // Light text (placeholders, disabled)
  { fg: 'gray500', bg: 'white', usage: 'Placeholder text (gray-placeholder)', size: 'normal' },
  { fg: 'gray500', bg: 'white', usage: 'Disabled text', size: 'normal' },
  { fg: 'gray400', bg: 'white', usage: 'Decorative only (not used for text)', size: 'large' },
  
  // User message (light text on dark background)
  { fg: 'gray50', bg: 'gray900', usage: 'User message text', size: 'normal' },
  { fg: 'white', bg: 'gray900', usage: 'User message text (white)', size: 'normal' },
  
  // Buttons
  { fg: 'gray50', bg: 'gray900', usage: 'Primary button text', size: 'normal' },
  { fg: 'gray950', bg: 'gray50', usage: 'Secondary button text', size: 'normal' },
  
  // Error states
  { fg: 'gray800', bg: 'gray150', usage: 'Error banner text', size: 'normal' },
  { fg: 'gray700', bg: 'gray100', usage: 'Offline banner text', size: 'normal' },
...
console.log('Standard: 4.5:1 for normal text, 3:1 for large text/UI components\n');
...
if (failures.length > 0) {
  ...
  failures.forEach(({ fg, bg, usage, ratio, threshold }) => {
    const isCritical = !usage.toLowerCase().includes('decorative') && 
    ...
    if (!isCritical) {
      console.log(`  Note: This is acceptable - element is supplemented by other visual cues`);
    } else {
  ...
  if (criticalFailures.length > 0) {
    ...
    console.log('⚠ Some decorative elements have lower contrast but are supplemented by other cues.');
    process.exit(0);
  }
} else {
